...
public class Application {
    ...
    private static void chooseSubMenu() {
        ...
        do{
            ...
            int no = sc.nextInt();
            switch (no){
                case 1: menuService.findMenuBySupCategory(inputSupCategory()); break;
                case 9:
                    return;
            }
        } while(true);
    ...
    private static void foreachSubMenu() {
        ...
        do {
            ...
            switch (no){
                case 1: menuService.searchByRandomMenuCode(createRandomMenuCodeList());break;
                case 9:
                    return;
            }
        }while(true);
