...
<body>
    ...
    <form action="querystring" method="get">
        ...
        <input type="checkbox" name="hobbies" id="sleep">
        <label for="sleep">수면</label>
        <br>
        <input type="submit" value="전송">
    </form>

    <h4>a태그의 href속성에 직접 파라미터를 쿼리스트링 형태로 작성하여 get요청</h4>
    <a href="querystring?name=김도현&age=25&birthday=1999-05-07&gender=M&nationality=ko&hobbies=movie">
        쿼리 스트링을 이용한 값 전달
    </a>
    ...
    <form action="formdata" method="post">
        ...
        <input type="checkbox" name="hobbies" id="sleep2">
        <label for="sleep2">수면</label>
        <br>
        <input type="submit" value="전송">
    </form>
</body>
