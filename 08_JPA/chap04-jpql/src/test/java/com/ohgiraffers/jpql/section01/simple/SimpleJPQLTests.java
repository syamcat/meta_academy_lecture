...
public class SimpleJPQLTests {
    ...
    @ParameterizedTest
    @CsvSource({"1, 망고빙수", "2, 우럭스무디", "3, 생갈치쉐이크"})
    ...
    @DisplayName("DISTICT를 활용한 중복 제거 여러 행 조회 테스트")
    @Test
    ...
    void testInOperator(List<Integer> categoryCodes) {
        ...
        List<Menu> foundMenus = menuFindService.findAllMenusInCategoryCodes(categoryCodes);
